tekst=("""Sam /pan Tadeusz/ został w armii adiutantem,
...
Że się Francuzi słuchając, uczuł najszczęśliwszy...
„Vos larmes" — rzekł — „et vos beaux yeux..." i tak kom-
plementa
...
fragment = tekst[0:200]
print("\n----Fragment---")
print(fragment)
print("\n---FRAGMENT DUZYMI LITERAMI---")
print(fragment.upper())

if "Adiudantem" in tekst:
    print("\nSlowo'Adiutantem' wystepuje w tekcjie")
else:
    print("\n Slowo 'Adiutantem' NIE wystepuje w tekcjie")